...
namespace Rocket.RDVQA.Tools.Core.Data.Extensions
{
    public static class PrintDataExtensions
    {
        ...
        private static void PrintColumns(string name, DataColumn[] columns)
        {
            ...
            WriteLine(format1, string.Empty, columnName, dataType, nullable, dataMember, Vertical_Bar);
            ...
            foreach (DataColumn column in columns)
            {
                ...
                WriteLine(format2, column.Ordinal, column.ColumnName, column.DataType, column.AllowDBNull, dataMemberType, Vertical_Bar);
            }
        ...
        private static void PrintRows(DataTable dataTable, IEnumerable<DataRow> dataRows, bool rowOrdinals, int top, ValueToStringHandler toString, string[] columnNames, string ordinalColumnName = null)
        {
            ...
            string formatHeaders = Vertical_Bar.ToString();
            string format = Vertical_Bar.ToString();
            ...
            if (rowOrdinals)
            {
                ...
                formatHeaders += string.Format(" {{0,-{0}}} {1}", rowOrdinalsLength, Vertical_Bar);
                format += string.Format(" {{0,{0}}} {1}", rowOrdinalsLength, Vertical_Bar);
            }

            int k = 0;
            for (; k < columns.Length - 1; k++)
            {
                string horizontal = new String(Horizontal_Bar, lengths[k] + 5); //srk
                header += horizontal + Top_Center;
                separator += horizontal + Middle_Center;
                footer += horizontal + Bottom_Center;

                string cellFormat = string.Format(" {{{0},-{1}}} {2}", k + 1, lengths[k], Vertical_Bar);
        ...
        private static void PrintListRows(DataTable dataTable, IEnumerable<DataRow> dataRows, bool rowOrdinals, int top, ValueToStringHandler toString, int repeatColumns, RepeatDirection repeatDirection, string delimiter, string[] columnNames, string ordinalColumnName = null)
        {
            ...
            string cellFormat = string.Format(" {{{{0,-{0}}}}}{1}{{{{{{0}},-{2}}}}} {3}", columnsLength, delimiter, rowsLength, Vertical_Bar);
        ...
        private static char Vertical_Bar;
        ...
        public static void ASCIIBorder()
        {
            ...
            Vertical_Bar = ASCII_VERTICL_BAR;
            Top_Left = ASCII_PLUS;
        ...
        public static void ExtendedASCIIBorder()
        {
            ...
            Vertical_Bar = EXTENDED_ASCII_VERTICL_BAR;
